...
-- -----------------------------------------------------
-- Table `itunes`.`number_of_download`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `itunes`.`number_of_download` (
  `quantity` INT NOT NULL,
  `Download_id` INT NOT NULL,
  PRIMARY KEY (`quantity`),
  INDEX `Number_of_download_Download` (`Download_id` ASC) VISIBLE,
  CONSTRAINT `Number_of_download_Download`
